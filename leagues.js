module.exports = function(){
    ...
    router.post('/', function(req, res){
        ...
        var mysql = req.app.get('mysql');
        var sql = "INSERT INTO fantasy_leagues (commissioner_id, league_name, number_of_teams) VALUES (?,?,?)";
    ...
    router.put('/:id', function(req, res){
        ...
        var sql = "UPDATE fantasy_leagues SET league_name=?, number_of_teams=? WHERE league_id = ?";
        var inserts = [req.body.name, req.body.number_of_teams, req.params.id];
        sql = mysql.pool.query(sql,inserts,function(error, results, fields){
            if(error){
                console.log(error)
                res.write(JSON.stringify(error));
...
//         console.log(req.body)
//         var mysql = req.app.get('mysql');
//         var sql = "INSERT INTO fantasy_leagues (league_name, number_of_teams) VALUES (?,?)";
//         var inserts = [req.body.league_name, req.body.number_of_teams];
//         sql = mysql.pool.query(sql,inserts,function(error, results, fields){
//             if(error){
//                 console.log(JSON.stringify(error))
//                 res.write(JSON.stringify(error));
