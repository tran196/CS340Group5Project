module.exports = function(){
    ...
    function getPlanets(res, mysql, context, complete){
        mysql.pool.query("SELECT league_id FROM fantasy_leagues", function(error, results, fields){
            if(error){
    ...
    function getPeople(res, mysql, context, complete){
        mysql.pool.query("SELECT league_id, commissioner_id, league_name, number_of_teams FROM fantasy_leagues", function(error, results, fields){
            if(error){
                res.write(JSON.stringify(error));
                res.end();
            }
